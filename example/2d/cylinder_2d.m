...
wvlen = 700;  % wavelength
inc_ang = pi/4;  % incidence angle in the yz plane
[E, H, obj_array, src_array, J] = maxwell_run(...
	'OSC', L0, wvlen, ...
	'DOM', {'vacuum', 'none', 1.0}, [-b b; -b b; 0 dL], dL, BC.p, [10*dL 10*dL 0], ...
	'OBJ', ...
		{'vacuum', 'blue', 1.0}, Box([-sm sm; -sm sm; 0 dL], [dl dl dL]), ...  % flux measurement box
		{'Palik/GaAs', 'y'}, CircularCylinder(Axis.z, dL, [0 0 dL/2], r, [dl dl dL]), ...  % GaAs cylinder
