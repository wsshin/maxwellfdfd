...
% 	'SRCJ', PlaneSrc(Axis.x, 0, polarization), ...  % PlaneSrc(plane_normal_axis, intercept, polarization_axis)
% 	inspect_only);
...
% 	'OBJ', {'vacuum', 'none', 1.0}, Plane(Axis.y, flux_loc), ...
% 	'SRCJ', PlaneSrc(Axis.y, 0, polarization), ...  % PlaneSrc(plane_normal_axis, intercept, polarization_axis)
% 	inspect_only);  
...
[E, H, obj_array, src_array, J] = maxwell_run(...
	...
	'DOM', {'vacuum', 'none', 1.0}, [-50, 50; -60, 60; 0, 1], 1, BC.p, [0 10 0], ...
	'OBJ', {'vacuum', 'none', 1.0}, Plane(Axis.y, flux_loc), ...
	'SRCJ', PlaneSrc(Axis.y, 0, polarization, 1, pi/4, wvlen), ...  % PlaneSrc(normal_axis, intercept, polarization, K, theta, wvlen)
	inspect_only);  
